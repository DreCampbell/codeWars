...
//PARAMETERS: an array of the reindeer's full names

//RETURNS: the names sorted by last name
...
//PSEUDOCODE: iterate through all the names and flip the names, then sort, then flip them back
*/
