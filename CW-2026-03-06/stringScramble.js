...
//PARAMETERS: a string and an array of numbers which represent indices

//RETURNS: the string rearranged so each character maches the position specified by the array indices
...
//PSEUDOCODE: create a variable to hold an empty result array, run a for loop from 0 to the length of the string, incrementing by 1; then reassign the string letters to the corresponding array indices
*/
