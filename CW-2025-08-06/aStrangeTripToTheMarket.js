...
//RETURNS: true if the string contains the phrases "tree fiddy", "3.50", or "tree fifty"

//EXAMPLES: 
    isLochNessMonster("Your girlscout cookies are ready to ship. Your total comes to tree fiddy", true);
    isLochNessMonster("Howdy Pardner. Name's Pete Lexington. I reckon you're the kinda stiff who carries about tree fiddy?", true);
    isLochNessMonster("I'm from Scottland. I moved here to be with my family sir. Please, $3.50 would go a long way to help me find them", true);
    isLochNessMonster("Yo, I heard you were on the lookout for Nessie. Let me know if you need assistance.", false);
    isLochNessMonster("I will absolutely, positively, never give that darn Lock Ness Monster any of my three dollars and fifty cents", false);
    isLochNessMonster("Did I ever tell you about my run with that paleolithic beast? He tried all sorts of ways to get at my three dolla and fitty cent? I told him 'this is MY 4 dolla!'. He just wouldn't listen.", false);
    isLochNessMonster("Hello, I come from the year 3150 to bring you good news!", false);
    isLochNessMonster("By 'tree fiddy' I mean 'three fifty'", true);
    isLochNessMonster("I will be at the office by 3:50 or maybe a bit earlier, but definitely not before 3, to discuss with 50 clients", false);
    isLochNessMonster("tree fifty", false);
    isLochNessMonster("three fiddy", false);
    isLochNessMonster("", false);

//PSEUDOCODE: check if the string includes one of the 3 phrases with the includes method
*/
