...
//PARAMETERS: an array of numbers, and a separate digit, n

//RETURNS: the last n even digits in the array
...
//PSEUDOCODE: filter the array to get only even numbers then use the slice method to get the last n number of digits
*/
