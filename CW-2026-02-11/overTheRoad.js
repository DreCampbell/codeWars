...
//PARAMETERS: two positive numbers, your address and the number of houses on each side of the street

//RETURNS: the house number that would be opposite your address
...
//PSEUDOCODE: multiply n times 2 then add 3, then subtract the address
*/
