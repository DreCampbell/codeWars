...
//PARAMETERS: two words

//RETURNS: the words returned with the first letter of each word switched
...
//PSEUDOCODE: reassign the string to an array of two words, then using the slice method combine the first letter of the second word with the remainder of the letters from the first word, and vice versa, to get the correct words
*/
