...
//PARAMETERS: a string and two numbers, a location and a number

//RETURNS: the selected string at loc, repeated num about of times
...
//PSEUDOCODE: split the string into an array of words, use square brackets to get the word in loc index, concatinate a "-", then use repeat(num) to "multiply the word", then use slice(0, -1) to remove the last "-"
*/
