...
//PARAMETERS: a nested array with arrays of numbers

//RETURNS: return the sum of the smallest number in each of the arrays

//EXAMPLES: 
    (sumOfMinimums([[7, 9, 8, 6, 2], [6, 3, 5, 4, 3], [5, 8, 7, 4, 5]]), 9);
    (sumOfMinimums([[11, 12, 14, 54], [67, 89, 90, 56], [7, 9, 4, 3], [9, 8, 6, 7]]), 76);

//PSEUDOCODE: iterate through the array retuning the smallest number with Math.min(), then use the reduce method to get the sum
*/
