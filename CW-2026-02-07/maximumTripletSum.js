...
//RETURNS: the sum of the 3 largest numbers, excluding duplicates
...
//PSEUDOCODE: remove the duplicates, sort the array from largest to smallest. slice the first three elements, then use reduce to get the sum
*/

function maxTriSum(numbers){
    return numbers.filter((x, i) => numbers.indexOf(x) == i).sort((a, b) => b - a).slice(0, 3).reduce((a, b) => a + b, 0);
}
